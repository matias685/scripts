...
sudo echo 'options hid_apple swap_opt_cmd=1'
...
sudo dnf -y install neofetch git-core gnome-tweaks gnome-system-monitor git-core setroubleshoot gnome-software PackageKit PackageKit-command-not-found fedora-workstation-repositories zsh
